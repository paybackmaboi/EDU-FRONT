    ...
    <main className="grid gap-4 p-4 max-w-screen-lg mx-auto sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="relative flex items-center justify-center overflow-hidden rounded-lg bg-gray-100 shadow-lg group h-64">
            ...
            <div className="relative flex flex-col items-center justify-center text-white p-6 z-10 w-full h-full text-center">
                ...
                <p className="mt-2 italic text-sm">tabadidoy</p>
                <a href="#roadmap" className="mt-4 px-4 py-2 bg-gray-900 text-white font-bold text-xs uppercase tracking-wide rounded-lg hover:bg-gray-800 focus:outline-none focus:ring focus:ring-yellow-400">View</a>
            </div>
        </div>
        ...
        <div className="relative flex items-center justify-center overflow-hidden rounded-lg bg-gray-100 shadow-lg group h-64">
            ...
            <div className="relative flex flex-col items-center justify-center text-white p-6 z-10 w-full h-full text-center">
                ...
                <p className="mt-2 italic text-sm">tabadidoy gikalkal ang nodemodules</p>
